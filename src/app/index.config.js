(function() {
  ...
  function config($logProvider, toastrConfig,$translateProvider) {
    ...
    CONTACT_GT1:'PROFESSIONAL FOOTBALL PROGRAM',CONTACT_GT2:'TEL. (WHATSAPP)',CONTACT_GT3:'ACCOUNT IN HONG KONG',CONTACT_GT4:'ACCOUNT IN MACAO',
  ...
  $translateProvider.translations('chinese', {
    ...
    TERMS:'服務條款',
      ...
      CONTACT_GT1:'RACING PRO專業足球程式',CONTACT_GT2:'電話. (WHATSAPP)',CONTACT_GT3:'香港區户口',CONTACT_GT4:'澳門區户口',
